...
<body>
    ...
    <div class="header-top">
        <div class="header-left">
            ...
            <br>
            <?php if($enrollement->etudiant->concours): ?>
            <strong><?php echo e(strtoupper($enrollement->etudiant->concours->nom)); ?></strong><br>
            <?php echo e($enrollement->etudiant->concours->ville ?? ''); ?>

            <?php endif; ?>
        </div>
        <div class="header-center">
            <?php if($enrollement->etudiant->concours && $enrollement->etudiant->concours->logo): ?>
                <img src="<?php echo e(public_path('storage/' . $enrollement->etudiant->concours->logo)); ?>" style="width: 60px; height: 60px; object-fit: contain;" alt="Logo">
            <?php else: ?>
    ...
    <div class="main-title">
        <h1>FICHE D'INSCRIPTION AU CONCOURS D'ENTRÉE SESSION <?php echo e(date('Y')); ?></h1>
        <?php if($enrollement->etudiant->concours): ?>
        <div class="subtitle"><?php echo e(strtoupper($enrollement->etudiant->concours->nom)); ?></div>
        <?php endif; ?>
    </div>

    <div class="inscription-number">
        INSCRIPTION N° <span class="blue" style="font-size: 13px;"><?php echo e(str_pad($enrollement->id, 6, '0', STR_PAD_LEFT)); ?></span>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <div class="info-row">
                <div class="info-col">
                    <strong>Nom:</strong> <?php echo e(strtoupper($enrollement->etudiant->user->nom)); ?>

                </div>
                <div class="info-col">
                    <strong>Prénom:</strong> <?php echo e($enrollement->etudiant->user->prenom); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Date de naissance:</strong> <?php echo e(\Carbon\Carbon::parse($enrollement->etudiant->date_naissance)->format('d-m-Y')); ?>

                </div>
                <div class="info-col">
                    <strong>Lieu de naissance:</strong> <?php echo e($enrollement->etudiant->departement_origine ?? 'N/A'); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Sexe:</strong> <?php echo e($enrollement->etudiant->sexe == 'M' ? 'Masculin' : 'Féminin'); ?>
            ...
            <div class="info-row">
                <div class="info-col">
                    <strong>Région d'origine:</strong> <?php echo e($enrollement->etudiant->region_origine ?? 'N/A'); ?>

                </div>
                <div class="info-col">
                    <strong>Département d'origine:</strong> <?php echo e($enrollement->etudiant->departement_origine ?? 'N/A'); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>CNI:</strong> <?php echo e($enrollement->etudiant->numero_cni ?? 'N/A'); ?>

                </div>
                <div class="info-col">
                    <strong>Téléphone:</strong> <?php echo e($enrollement->etudiant->telephone ?? 'N/A'); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Adresse:</strong> <?php echo e($enrollement->etudiant->adresse); ?>

                </div>
                <div class="info-col">
                    <strong>Email:</strong> <?php echo e($enrollement->etudiant->user->email); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Langue parlée:</strong> <?php echo e($enrollement->etudiant->langue_parlee ?? 'Français'); ?>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <div class="info-row">
                <div class="info-col">
                    <strong>Filière:</strong> <?php echo e($enrollement->filiere->nom); ?>

                </div>
                <div class="info-col">
                    <strong>Diplôme/admission:</strong> <?php echo e($enrollement->niveau->nom ?? 'N/A'); ?>
            ...
            <div class="info-row">
                ...
                <div class="info-col">
                    <strong>Année diplôme:</strong> <?php echo e(date('Y')); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Centre d'examen:</strong> <?php echo e($enrollement->etudiant->centreExamen->nom ?? 'N/A'); ?>

                </div>
                <div class="info-col">
                    <strong>Centre de dépôt:</strong> <?php echo e($enrollement->centreDepot->nom ?? 'N/A'); ?>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <div class="info-row">
                <div class="info-col">
                    <strong>Nom du père:</strong> <?php echo e($enrollement->etudiant->nom_pere ?? 'N/A'); ?>

                </div>
                <div class="info-col">
                    <strong>Téléphone du père:</strong> <?php echo e($enrollement->etudiant->telephone_pere ?? 'N/A'); ?>

                </div>
            </div>
            <div class="info-row">
                <div class="info-col">
                    <strong>Nom de la mère:</strong> <?php echo e($enrollement->etudiant->nom_mere ?? 'N/A'); ?>

                </div>
                <div class="info-col">
                    <strong>Téléphone de la mère:</strong> <?php echo e($enrollement->etudiant->telephone_mere ?? 'N/A'); ?>
    ...
    <div class="footer-section">
        <div class="qr-section">
            <div class="qr-code">
                <img src="data:image/svg+xml;base64,<?php echo e($qrcode); ?>" width="80">
            </div>
            <p style="font-size: 7px; margin: 5px 0; color: #1e40af; font-weight: bold;">Scanner pour vérification</p>
        </div>
        <div class="candidate-code">
            <p><strong style="color: #1e40af;">Code Candidat:</strong> <span class="code"><?php echo e(str_pad($enrollement->id, 6, '0', STR_PAD_LEFT)); ?></span></p>
            <p style="margin-top: 8px; font-size: 9px; color: #1e3a8a;">
                <strong>Année académique:</strong> <?php echo e($enrollement->annee_academique); ?>

            </p>
            <p class="print-date">Imprimée le <?php echo e($date); ?></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/resources/views/pdf/enrollement.blade.php ENDPATH**/ ?>