...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Félicitations <?php echo e($enrollement->etudiant->user->prenom); ?> <?php echo e($enrollement->etudiant->user->nom); ?> !</h2>
            ...
            <div class="info-box">
                <p style="margin: 0;"><strong>Concours :</strong> <?php echo e($enrollement->etudiant->concours->nom ?? 'N/A'); ?></p>
                <p style="margin: 5px 0 0 0;"><strong>Numéro d'inscription :</strong> <span class="highlight"><?php echo e(str_pad($enrollement->id, 6, '0', STR_PAD_LEFT)); ?></span></p>
                <p style="margin: 5px 0 0 0;"><strong>Date de validation :</strong> <?php echo e(now()->format('d/m/Y à H:i')); ?></p>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($pdfUrl); ?>" class="btn">📥 Télécharger ma fiche d'enrôlement</a>
            </div>
...
<?php /**PATH /var/www/resources/views/emails/enrollement-validated.blade.php ENDPATH**/ ?>